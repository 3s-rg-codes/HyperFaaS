...
const (
	FunctionService_Ready_FullMethodName = "/function.FunctionService/Ready"
)
...
func (c *functionServiceClient) Ready(ctx context.Context, in *Payload, opts ...grpc.CallOption) (*Call, error) {
	...
	out := new(Call)
	err := c.cc.Invoke(ctx, FunctionService_Ready_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FunctionService_Ready_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FunctionService_Ready_FullMethodName,
	}
