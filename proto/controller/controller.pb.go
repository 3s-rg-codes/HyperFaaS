...
func (x *StatusRequest) GetInstanceId() *InstanceID {
	if x != nil {
		return x.InstanceId
	}
	return nil
...
var file_controller_controller_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x47, 0x0a, 0x0c,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x44, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x33, 0x0a, 0x0b, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x77, 0x6f,
	0x72, 0x6b, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x44, 0x52,
	0x0a, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x32, 0xd7, 0x01, 0x0a, 0x0a,
	...
	0x61, 0x74, 0x65, 0x30, 0x01, 0x42, 0x1c, 0x5a, 0x1a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x75, 0x63, 0x63, 0x61, 0x64, 0x69, 0x62, 0x65, 0x2f, 0x77, 0x2e,
...
var file_controller_controller_proto_depIdxs = []int32{
	...
	3, // 4: worker.StatusRequest.instance_id:type_name -> worker.InstanceID
	2, // 5: worker.Controller.Start:input_type -> worker.StartRequest
	5, // 6: worker.Controller.Call:input_type -> worker.CallRequest
	3, // 7: worker.Controller.Stop:input_type -> worker.InstanceID
	8, // 8: worker.Controller.Status:input_type -> worker.StatusRequest
