...
func (x *CallRequest) GetAsync() bool {
	if x != nil {
		return x.Async
	}
	return false
...
func (x *CreateFunctionRequest) GetImage() *Image {
	if x != nil {
		return x.Image
	}
	return nil
...
func (x *CreateFunctionRequest) GetConfig() *Config {
	if x != nil {
		return x.Config
	}
	return nil
...
type StateResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FunctionId    string                 `protobuf:"bytes,1,opt,name=function_id,json=functionId,proto3" json:"function_id,omitempty"`
	Have          bool                   `protobuf:"varint,2,opt,name=have,proto3" json:"have,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StateResponse) GetFunctionId() string {
	if x != nil {
		return x.FunctionId
	}
	return ""
...
func (x *StateResponse) GetHave() bool {
	if x != nil {
		return x.Have
	}
	return false
...
const file_common_common_proto_rawDesc = "" +
	...
	"\x05quota\x18\x02 \x01(\x03R\x05quota\"d\n" +
	...
	"functionId\"\x0e\n" +
	"\fStateRequest\"D\n" +
	"\rStateResponse\x12\x1f\n" +
	"\vfunction_id\x18\x01 \x01(\tR\n" +
	"functionId\x12\x12\n" +
	"\x04have\x18\x02 \x01(\bR\x04haveB/Z-github.com/3s-rg-codes/HyperFaaS/proto/commonb\x06proto3"
...
var file_common_common_proto_goTypes = []any{
	...
	(*CreateFunctionRequest)(nil),  // 6: common.CreateFunctionRequest
	(*CreateFunctionResponse)(nil), // 7: common.CreateFunctionResponse
	(*StateRequest)(nil),           // 8: common.StateRequest
	(*StateResponse)(nil),          // 9: common.StateResponse
}
var file_common_common_proto_depIdxs = []int32{
	0, // 0: common.CallResponse.error:type_name -> common.Error
	5, // 1: common.Config.cpu:type_name -> common.CPUConfig
	1, // 2: common.CreateFunctionRequest.image:type_name -> common.Image
	4, // 3: common.CreateFunctionRequest.config:type_name -> common.Config
