		...
		"worker1": []state.Function{
			{FunctionID: "func1", Idle: []state.Instance{
				{InstanceID: "instance1",
					LastWorked: time.Unix(6, 0).UTC(),
					Created:    time.Unix(5, 0).UTC(),
				},
				{InstanceID: "instance2",
					LastWorked: time.Unix(6, 0).UTC(),
					Created:    time.Unix(4, 0).UTC(),
				},
				{InstanceID: "instance3",
					LastWorked: time.Unix(8, 0).UTC(),
					Created:    time.Unix(5, 0).UTC(),
				},
			},
				Running: []state.Instance{
					{InstanceID: "instance4",
						LastWorked: time.Unix(11, 0).UTC(),
						Created:    time.Unix(10, 0).UTC(),
					},
					{InstanceID: "instance5",
						LastWorked: time.Unix(12, 0).UTC(),
						Created:    time.Unix(10, 0).UTC(),
					},
				},
			},
		...
		"worker2": []state.Function{
			{FunctionID: "func2", Idle: []state.Instance{
				{InstanceID: "instance6",
					LastWorked: time.Unix(13, 0).UTC(),
					Created:    time.Unix(12, 0).UTC(),
				},
				{InstanceID: "instance7",
					LastWorked: time.Unix(14, 0).UTC(),
					Created:    time.Unix(16, 0).UTC(),
				},
			},
				Running: []state.Instance{
					{InstanceID: "instance8",
						LastWorked: time.Unix(17, 0).UTC(),
						Created:    time.Unix(18, 0).UTC(),
					},
					{InstanceID: "instance9",
						LastWorked: time.Unix(19, 0).UTC(),
